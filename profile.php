<!DOCTYPE html>
    ...
    <body style="font-family: tahoma; background-color: #e9ebee; ">
        ...
        <div style="width: 800px; margin: auto; min-height: 400px;">
            ...
            <div style="background-color: white; text-align: center; color: #6d4e94; ">
                <img src="dogpark.jpg" style="width: 100%;">
                <img id="profile_pic" src="selfie.jpg">
                <br>
                    <div style="font-size: 20px; ">Danny Kim</div>
                <br>
            ...
            <div style="display: flex;">
                ...
                <div style="min-height: 400px; flex:1;">
                    <div id="friends_bar">
                        ...
                        Friends<br>
                        <div id="friends">    
                            <img id="friends_img" src="2.jpg">
                            <br>
                            First User
                        </div>
                        <div id="friends">    
                            <img id="friends_img" src="3.jpg">
                            <br>
                            Second User
                        </div>
                        <div id="friends">    
                            <img id="friends_img" src="4.jpg">
                            <br>
                            Third User
                        </div>
                        <div id="friends">    
                            <img id="friends_img" src="5.jpg">
                            <br>
                            Fourth User
                        </div>
                    </div>
